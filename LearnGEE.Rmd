...
First, create sample data and calculate a matrix to use as a mask for the off-diagonal products for calculating variance. Also calculate the denominators for variance and covariance calculations.
